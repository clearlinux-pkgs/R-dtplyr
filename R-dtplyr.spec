...
Version  : 1.0.0
Release  : 8
URL      : https://cran.r-project.org/src/contrib/dtplyr_1.0.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/dtplyr_1.0.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1574317397
